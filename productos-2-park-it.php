...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas) - Car Stop 1</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Car Stop 1</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="topes-de-estacionamiento">Topes de estacionamiento</a></div>
	</div>
...
<div class="container">
 ...
 <div class="blog_postcontent">
                <div class="image_frame"><img src="img/topes-de-estacionamiento4.jpg" alt=""></div>
				</div>
	
 <br>
  <p>
 Usado para detener a los autos que se estacionan como tope de contención. Se utiliza en estacionamientos de uno o más niveles para designar los lugares de parqueo. Su altura es la ideal para no dañar los vehículos modernos de baja altura. No requiere de mantenimiento y es de alta durabilidad.<br><br>
Cada Tope es de 1.83m de largo x 15 cm de ancho x 10 cm de altura.<br><br>
<strong>PRODUCTO ECOL&Oacute;GICO HECHO DE LLANTAS RECICLADAS</strong></p>
  <br>
  <ul class="list_empty">
      <li><a href="pdf/F.T Car Stop.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
