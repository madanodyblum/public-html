...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas) - Speed Hump</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Speed Hump</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="reductores-de-velocidad">Reductores de velocidad (gibas)</a></div>
	</div>
...
<div class="container">
 ...
 <div class="blog_postcontent">
                <div class="image_frame"><img src="img/reductores-de-velocidad3.jpg" alt=""></div>
				</div>
            <img src="img/speed-hump1.jpg" alt="" class="image_left4" style="width: 45%; margin-bottom: 20px"> 
            <img src="img/speed-hump2.jpg" alt="" class="image_left4" style="width: 45%; margin-bottom: 20px">
 <br>
  <p>
  Reduce la velocidad a 3 - 8 km/h aproximadamente. Se utiliza en estacionamientos y garajes, zonas residenciales y zonas escolares. Está preparado para su instalación inmediata puede ser adaptado para tener distintos largos. <br><br>
Cada pieza es de 1m de largo x 30 cm de ancho x 6 cm de altura.<br><br>
De requerir cabeceros para el inicio y fin son de 15 cm de largo.<br><br>
<strong>PRODUCTO ECOL&Oacute;GICO HECHO DE LLANTAS RECICLADAS</strong></p>
  
  
  
  <br>
  <ul>
      <li><a href="pdf/F. T Speed Hump.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
