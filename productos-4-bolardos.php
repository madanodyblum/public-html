...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Bolardos</h1></div>
...
<div class="container">
   ...
   <div class="one_fill">
            ...
            <li>
                <ul class="gallery clearfix">
                  ...
                  <li class="border_threecol" style="text-align:center; width:45.8%; margin-top:12px"><a href="bolardo-de-fierro"><img src="img/bolardo-fierro1.jpg" alt="" /></a>
                    <strong>Bolardo de fierro</strong>
                  </li>

                  <li class="border_threecol" style="text-align:center; width:45.8%; margin-top:12px"><a href="bolardo-retractil"><img src="img/bolardo-retractil.jpg" alt="" /></a>
                    <strong>Bolardo retráctil</strong>
                  </li>                    
  ...
  <div class="blog_postcontent">
                <div class="image_frame"><a href="bolardos-de-plastico"><img src="img/bolardos2.jpg" alt=""></a></div>
				</div>
	
 <br>
  
  <p>Bolardos de plástico </p>
