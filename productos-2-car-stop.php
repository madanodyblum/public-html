...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas) - Car Stop 2</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Car Stop 2</h1></div>
...
<div class="container">
 ...
 <div class="blog_postcontent">
                <div class="image_frame"><img src="img/topes-de-estacionamiento5.jpg" alt=""></div>
				</div>
	
 <br>
  <p>
Tope  de estacionamiento conformado por dos piezas.<br><br>
Cada pieza es de 60 cm de largo x 15 cm de ancho x 10 cm de altura.<br><br>
<strong>PRODUCTO ECOL&Oacute;GICO HECHO DE LLANTAS RECICLADAS</strong></p>
  <br>
  <ul class="list_empty">
      <li><a href="pdf/ft-car-stop-2-nuevo.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
