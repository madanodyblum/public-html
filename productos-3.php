...
<head>
	...
	<title>BIZCOM PERÚ - Protectores de columnas y pared</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Protectores de columnas y pared</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> Protectores de columnas y pared</div>
	</div>
...
<div class="container">
  ...
  <h2>Protectores de columnas y pared</h2><br>
  ...
  <div class="one_fill">
            ...
            <li>
                <ul class="gallery clearfix">
                    <li class="border_threecol" style="text-align:center; width:45.8%"><a href="protector-columna"><img src="img/protectores-de-columnas-pared4.jpg" alt="" />
                    <strong>Protector de Columna</strong></a>
                    </li>
                    
                  <li class="border_threecol" style="text-align:center; width:45.8%"><a href="protector-pared"><img src="img/protectores-de-columnas-pared5.jpg" alt="" /></a>
                    <strong>Protector de Pared</strong>
                  </li>
                  
                  <li class="border_threecol" style="text-align:center; width:45.8%; margin-top:12px"><a href="protector-de-pared-direccional"><img src="img/protectores-de-pared-direccional-entrada.jpg" alt="" /></a>
                    <strong>Protector de Pared Direccional</strong>
                  </li>
