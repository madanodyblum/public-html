...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas) - CADENA ESLABONADA PLÁSTICA</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Cadena Eslabonada Plástica</h1></div>
...
<div class="container">
 ...
 <div class="blog_postcontent">
                <div class="image_frame"><img src="img/cadena-plastica-negro-amarillo.jpg" alt=""></div>
				</div>
	
 <br>
  <p>
 Material : Polietileno con protección UV para mayor durabilidad.<br>
Medidas :  Rollo de 25 m, eslabon 10 mm de diametro.<br>
Color: Amarillo con negro<br>
Usos : Señalización de obras, instalaciones industriales, comerciales, viales , recreativas, de estacionamientos, etc.<br><br>
<strong>CADENA ESLABONADA PLÁSTICA</strong></p>
  <br>
  <ul class="list_empty">
      <li><a href="#" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
