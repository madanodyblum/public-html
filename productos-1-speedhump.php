...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas) - Speed Bump</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Speed Bump</h1></div>
...
<div class="container">
	...
	<div class="content_left">
            ...
            <ul class="fullimage_box">
                ...
                <li><img src="img/speed-bump1.jpg" alt=""></li>
            </ul>

            <ul class="fullimage_box last">

                <li><img src="img/speed-bump2.jpg" alt=""></li>

            </ul><br>
            <ul class="fullimage_box" style="margin-right: 310px">

                <li><img src="img/speed-bump3.jpg" alt=""></li>
            </ul>
  ...
  <p>
  Reduce la velocidad a 16 - 25 km/h. Reduce la velocidad del tránsito permitiendo un flujo continuo. <br><br>
Cada pieza es de 50cm de largo x 90 cm de ancho x 5.5cm de altura.<br><br>
Los cabeceros que van en el inicio y final  son de 25cm de largo x 90 cm de ancho x 5.5cm de altura.<br><br>	
<strong>PRODUCTO ECOL&Oacute;GICO HECHO DE LLANTAS RECICLADAS</strong></p>


  <ul class="list_empty"><br>
      <li><a href="pdf/F.T. Speed Bump.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
