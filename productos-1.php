...
<head>
	...
	<title>BIZCOM PERÚ - Reductores de velocidad (gibas)</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Reductores de velocidad (gibas)</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> Reductores de velocidad (gibas)</div>
	</div>
...
<div class="container">
  ...
  <div class="one_fill">
            ...
            <li>
                <ul class="gallery clearfix">
                    <li class="border_threecol" style="text-align:center; width:45.8%"><a href="speed-hump"><img src="img/reductores-de-velocidad1.jpg" alt="" />
                            <strong>Speed Hump</strong></a>
                    </li>

                    <li class="border_threecol" style="text-align:center; width:45.8%"><a href="speed-bump"><img src="img/reductores-de-velocidad2.jpg" alt="" /></a>
                        <strong>Speed Bump</strong>
                    </li>

                    <li class="border_threecol" style="text-align:center; width:45.8%; margin-top:12px"><a href="speed-cushion"><img src="img/reductores-de-velocidad3-1.jpg" alt="" /></a>
                        <strong>Speed Cushion (vías publicas)</strong>
                    </li>
                    
                    <li class="border_threecol" style="text-align:center; width:45.8%; margin-top:12px"><a href="boyas-con-reductores-de-velocidad"><img src="img/boyas-con-reductores-de-velocidad1.jpg" alt="" /></a>
                        <strong>Boyas como Reductores de Velocidad</strong>
                    </li>
