...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Speed hump worm</h1></div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
                <div class="image_frame"><img src="img/speed-hump-worm.jpg" alt=""></div>
				</div>
	
 <br>
  
  <p>
  De polietileno de alto peso molecular con cristales circulares, ideales para delimitar ciclovías,  vías de doble sentido,  carriles exclusivos, etc.  Soporta gran peso sobre ellas, de fácil instalación.
  </p><br>
  <img src="img/speed-hump-worm1.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px"> 
  <img src="img/speed-hump-worm2.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px">
  <img src="img/speed-hump-worm3.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px">
            
  

  <br>
  <ul class="list_empty">
        	<li><a href="pdf/Ficha Tecnica Tyre Killer.pdf" class="but_pdf" target="_blank">Ver Ficha Tecnica Tyre Killer - PDF</a></li>
        </ul>
