...
<head>
	...
	<title>BIZCOM PERÚ - Delimitador vial - Tachas u ojos de gato</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Tachas u ojos de gato</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="delimitador-vial">Delimitador vial</a></div>
	</div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
                <div class="image_frame"><img src="img/tachas2.jpg" alt=""></div>
				</div>
...
<ul class="list2">
				<li>Diseñada para brindar máxima resitencia al impacto.</li>
        <li>Diseño innovador de esquinas redondeadas y plástico de alto impacto.</li>
        <li>Alto grado de reflejo.</li>
        <li>Colores brillantes para mayor visibilidad.</li>
</ul>
<strong>Especificaciones:</strong>
<ul class="list2">
				<li>Lente: Reflector de prisma cúbico moldeado en acrílico grado óptico.</li>
        <li>Cuerpo: Plástico de alto impacto en diferentes colores.</li>
        <li>Empaque: Caja con 50 piezas.</li>
        <li>Colores: Ámbar, blanco y rojo.</li>
</ul>

<strong>Procedimiento de instalción</strong>
<ul class="list2">
				<li>Limpiar perfectamente el área de contacto.</li>
        <li>Asegurarse de que esté libre de polvo y húmedad.</li>
        <li>Aplicar suficiente adhesivo de tal manera que exista una película de 2 a 3 mm entre la superficie y la violeta.</li>
        <li>Asegurarse de retirar el axceso de adhesivos frente al reflejante.</li>
</ul>
   </p>
