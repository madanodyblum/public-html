...
<head>
	...
	<title>BIZCOM PERÚ - Bloqueador de Estacionamiento</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Bloqueador de Estacionamiento</h1></div>
                <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="contenedores-y-tachos-de-basura">Bloqueador de Estacionamiento</a></div>
	</div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
                <div class="image_frame"><img src="img/Bloqueador-A2.jpg" alt=""></div>
                </div>
            <img src="img/Bloqueador-A3.jpg" alt="" class="image_left4" style="width: 45%; margin-bottom: 20px"> 
            <img src="img/Bloqueador-A1.jpg" alt="" class="image_left4" style="width: 45%; margin-bottom: 20px">
 <br>
  
  - Bloqueador de estacionamiento manual con llave Tamaño: Φ6 x 80 cm<br>
- Altura: 35 cm<br>
- El tamaño del tubo: Ø6cm x 2mm<br>
- Tamaño de la base: Ø12.5cm<br>
- Material: acero recubierto de alta calidad<br> <br> <br>
  
  <ul >
      <li><a href="pdf/Ficha-Bloqueador-de-Estacionamiento.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
