...
<head>
	...
	<title>BIZCOM PERÚ - Espejos circulares para estacionamientos</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Espejos circulares para estacionamientos</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> Espejos circulares para estacionamientos</div>
	</div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
      <div class="image_frame"><img src="img/espejos-circulares.jpg" alt=""></div>
				</div>
  ...
  <br>
  <ul class="list_empty">
        	<li>Espejos Circulares para estacionamientos, 60 cm de diámetro.</li>
        </ul>
  
  <br><br><br>
                        <ul class="list_empty">
                            <li><a href="pdf/Ficha Espejo.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
                        </ul>
