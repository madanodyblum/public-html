...
<head>
	...
	<title>BIZCOM PERÚ - Topes de estacionamiento</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Topes de estacionamiento</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> Topes de estacionamiento</div>
	</div>
...
<div class="container">
  ...
  <div class="one_fill">
            ...
            <li>
                <ul class="gallery clearfix">
                    <li class="border_threecol" style="text-align:center; width:45.8%"><a href="car-stop-1"><img src="img/topes-de-estacionamiento2.jpg" alt="" />
                    <strong>Car Stop 1</strong></a>
                    </li>
                    
                  <li class="border_threecol" style="text-align:center; width:45.8%"><a href="car-stop-2"><img src="img/topes-de-estacionamiento3.jpg" alt="" /></a>
                    <strong>Car Stop 2</strong>
                  </li>
