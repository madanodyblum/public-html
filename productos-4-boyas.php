...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Boyas</h1></div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
                <div class="image_frame"><img src="img/boyas2.jpg" alt=""></div>
				</div>
 ...
 <br>
  ...
  <img src="img/boyasnuevas1.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px"> 
  <img src="img/boyasnuevas2.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px">
  <img src="img/boyasnuevas3.jpg" alt="" class="image_left4" style="width: 40%; margin-bottom: 20px">
            
  

  <br>
  <ul class="list_empty">
        	<li><a href="pdf/boya20_12.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
