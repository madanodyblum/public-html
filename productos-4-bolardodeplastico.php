...
<head>
	...
	<title>BIZCOM PERÚ - Delimitador vial - Tachas u ojos de gato - Bolardos de Plástico</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Bolardos de Plástico</h1></div>
...
<div class="container">
  ...
  <p>
  <ul class="fullimage_box" style="width: 40%; margin-right: 5%"  >
        	
      <li><img src="img/bolardo-plastico-1.JPG" alt="Bolardo de plastico"></li>
        </ul>
        <ul class="fullimage_box" style="width: 40%; margin-right: 5%"  >

            <li><img src="img/bolardo-flexible-plastico.jpg" alt="Bolardo flexible de plastico"></li>
            <strong>Bolardo Flexible Plastico 75 cm</strong></li>
        </ul>

<ul class="fullimage_box last" style="width: 21.75%">
        	
    <li><img src="img/bolardo-plastico-2.JPG" alt="Bolardo de plastico"></li>

        </ul>

  <ul class="list_empty">  <br>
      <li><a href="pdf/Ficha-Bolardos-Robot.pdf" class="but_pdf" target="_blank">Ver ficha técnica</a></li>
        </ul>
