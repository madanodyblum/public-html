...
<head>
	...
	<title>BIZCOM PERÚ - Radar / Cámara de detección de velocidad</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Radar / Cámara de detección de velocidad</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="delimitador-vial">Radar / Cámara de detección de velocidad</a></div>
	</div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
      <div class="image_frame"><img src="img/radar-camara-deteccion-de-velocidad-1.jpg" alt=""></div>
				</div>
	
 <br>
  <p>Para mayor información ingresar a <a href="http://www.viionsystems.com/" target="_blank">www.viionsystems.com</a></p>
  
  <br>
  <ul class="list_empty">
        	<li><a href="pdf/Viion-TrafficCam-I.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - Viion TrafficCam</a></li>
            <li><a href="pdf/Viion-TrafficCam3D.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - Viion TrafficCam3D</a></li>
        </ul>
