...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Speed Cushion (vías publicas)</h1></div>
...
<div class="container">
 ...
 <div class="blog_postcontent">
                <div class="image_frame"><img src="img/speed-cushion2.jpg" alt=""></div>
				</div>
	
 <br>
  <p>
+ Evita accidentes.<br>
+ Ayuda a reducir la velocidad sin causar daños a los vehículos.<br>
+ Construidos según normas técnicas reconocidas internacionalmente.<br>
+ Instalación sencilla y rápida, no se construye en la vía se instala.<br>
+ Hecho de caucho (llantas recicladas).<br>
+ Producto Ecológico.<br>
+ Diversos colores.</p>
<br>
<!--  <ul class="list_empty">
        	<li><a href="pdf/speed-cushion.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>-->
