        ...
        <div class="site_wrapper">
            <div class="boxed_wrapper">
                ...
                <div class="page_title">
                    ...
                    <div class="container">
                        <div class="leaft_title"><h1>Protector de Columna o esquineros</h1></div>
                        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i><a href="protectores-de-columnas-y-pared">Protectores de columnas y pared</a></div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="content_left">
                        <div class="blog_postcontent">
                            <div class="image_frame"><img src="img/protectores-de-columnas-pared2.jpg" alt=""></div>
                        </div>

                        <br>
                        <p>
                            Estos protectores planos o redondeados hechos de hule virgen son una solución muy duradera y de bajo costo. La cinta reflectiva incrementa su visibilidad, especialmente de noche, y provee la guía necesaria para estacionarse a los automovilistas.<br><br>
                            Sus medidas son:<br><br>
                            1m de altura x 10 cm de lados<br>
80 cm de altura x 10 cm lados
                            <br><br><br>
                        <ul class="list_empty">
                            <li><a href="pdf/Ficha Tecnica Protectores de Columna AI.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
                        </ul>
