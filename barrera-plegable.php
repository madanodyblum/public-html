...
<head>
	...
	<title>BIZCOM PERÚ - Barrera Plegable</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Barrera Plegable</h1></div>
        <div class="reght_pagenation"><a href="inicio">Inicio</a> <i>/</i> <a href="productos">Productos</a> <i>/</i> <a href="delimitador-vial">Barrera Plegable</a></div>
	</div>
...
<div class="container">
  ...
  <div class="blog_postcontent">
      <div class="image_frame"><img src="img/barrera-plegable-inter.jpg" alt=""></div>
				</div>
	
 <br>
  
  <p>
     Descripción: Hechas de PVC de 1.07 m de altura y se expande hasta 2.35 m, su empaque es tipo maleta, colores rojo con blanco.

  </p>
  <br>
  <ul class="list_empty">
        	<li><a href="pdf/ficha-tecnica-barrera-plegable.pdf" class="but_pdf" target="_blank">Ver Ficha Técnica - PDF</a></li>
        </ul>
